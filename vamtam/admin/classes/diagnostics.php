	...
	public static function tests() {
		...
		self::$test_results = [
			...
			'mixedcontent' => [
				...
				'pass'   => ! $mixed_content,
				'msg'    => esc_html__( 'This page was loaded over HTTPS, however URLs using HTTP were found in the database. Please replace all HTTP links with their HTTPS equivalents.', 'finovate' ),
			],
			'memory_frontend' => [
