...
// Enqueue purple theme styles
function vamtam_enqueue_purple_theme() {
	wp_enqueue_style( 'purple-theme', get_template_directory_uri() . '/purple-theme.css', array(), '1.0.0' );
}
add_action( 'wp_enqueue_scripts', 'vamtam_enqueue_purple_theme' );

// build: 4184f5218763f7778a59a9949a28fa0e8ba71355
